    ...
    <main className={styles.main}>
      ...
      <header className={styles.header}>
        ...
        <div className={styles.navLinks}>
          <a
            href="https://github.com/nayan100"
            target="_blank"
          ...
          <a
            href="https://www.linkedin.com/in/nayan-moni-hazarika-981022186/"
            target="_blank"
            rel="noopener noreferrer"
          >
            <svg
      ...
      <section className={styles.hero}>
        ...
        <h1 className={styles.title}> IoT Developer & Tech Strategist</h1>
        <p className={styles.subtitle}>
          Engineering the Autonomy of Things at Scale. I bridge the gap between
          low-level hardware constraints and high-concurrency cloud scaling.
        </p>

        <div className={styles.badge}>
          <Zap size={18} fill="currentColor" />
          <span>
            Delivering enterprise-grade systems with{" "}
            <strong>70% greater efficiency</strong> via Agentic Workflows.
          </span>
        </div>
      ...
      <section id="pillars" className={styles.section}>
        <div className={styles.sectionHeader}>
          ...
          <p>
            Core competencies defined by industrial rigor and massive-scale
            engineering.
          </p>
        </div>
        ...
        <div className={styles.pillarsGrid}>
          <div className={styles.pillarCard}>
            ...
            <p className={styles.pillarDesc}>
              Architecting high-concurrency backend ecosystems on AWS/GCP to
              support 100,000+ concurrent vehicles and 70,000+ real-time MQTT
              streams with 99.9% uptime.
            </p>
          </div>
          ...
          <div className={styles.pillarCard}>
            ...
            <h3 className={styles.pillarTitle}>
              Industrial Rigor & Compliance
            </h3>
            <p className={styles.pillarDesc}>
              Designing secure edge-to-cloud architectures that strictly adhere
              to MISRA C/C++ safety guidelines, ISA-95 for industrial control,
              and AIS-140 telematics.
            </p>
          </div>
          ...
          <div className={styles.pillarCard}>
            ...
            <p className={styles.pillarDesc}>
              Pioneering the AI-Native SDLC. Replacing manual code review and
              research cycles with AI-driven validation (Gemini CLI, Agentic
              Workflows) to reduce latency by 60%.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="work" className={styles.section}>
        <div className={styles.sectionHeader}>
          ...
          <p>
            Selected architectural implementations and "Clean-Room" reference
            projects.
          </p>
        </div>
        ...
        <div className={styles.workGrid}>
          <div className={styles.workCard}>
            <div className={styles.workContent}>
              ...
              <h3 className={styles.workTitle}>
                AIS-140 Telemetry Architecture
              </h3>
              <p>
                Handling 100k+ concurrent IoT streams with sub-second latency
              ...
              <a
                href="https://github.com/nayan100/reference-ais140-scale"
                target="_blank"
          ...
          <div className={styles.workCard}>
            <div className={styles.workContent}>
              ...
              <h3 className={styles.workTitle}>
                Mining 4.0 Digital Twin (ISA-95)
              </h3>
              <p>
                Secure Edge-to-Cloud mesh network for hazardous environments
                featuring OTA and Secure Boot.
              </p>
              <div className={styles.workTags}>
              ...
              <a
                href="https://github.com/nayan100/mining-4.0-digital-twin-poc"
                target="_blank"
                className={styles.workLink}
              >
          ...
          <div className={styles.workCard}>
            <div className={styles.workContent}>
              ...
              <p>
                Deterministic 60-second audits and MISRA-C:2012 modernization of
                legacy firmware stacks.
              </p>
              <div className={styles.workTags}>
              ...
              <a
                href="https://github.com/nayan100/safety-critical-automation"
                target="_blank"
                className={styles.workLink}
              >
      ...
      <section id="trajectory" className={styles.section}>
        <div className={styles.sectionHeader}>
          ...
          <p>
            A 5-year sprint from Engineer to VP, defining a career of rapid
        ...
        <div className={styles.timeline}>
          <div className={styles.timelineItem}>
            ...
            <h3 className={styles.timelineTitle}>IoT Developer</h3>
            <div className={styles.timelineCompany}>
              Vyomchara (IIT Dhanbad Incubated)
            </div>
            <div className={styles.timelineDesc}>
              Leading Mining 4.0 initiatives and Govt. 5G infrastructure.
              <ul>
                <li>
                  Architected mesh-networked Digital Twins for hazardous mines.
                </li>
          ...
          <div className={styles.timelineItem}>
            ...
            <div className={styles.timelineCompany}>
              TrackX (formerly CarX.io)
            </div>
            <div className={styles.timelineDesc}>
              Scaled from Intern to VP, managing India's largest fleet telemetry
              engine.
              <ul>
                <li>
                  Managed backend for 100k+ concurrent vehicles (99.9% uptime).
                </li>
                <li>
                  Led AIS-140 regulatory compliance and government contracts.
                </li>
                <li>
                  Owned P&L for Tech Dept, optimizing multi-million dollar
                  OpEx/CapEx.
                </li>
              </ul>
            </div>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.navLinks} style={{ display: "flex" }}>
          ...
          <a href="mailto:nayanmoni318@gmail.com">
            <Mail size={20} />
          </a>
        </div>
      </footer>
